    ...
    for (i = 0; i < signals.length; i++) {
      ...
      switch (sig.type) {
        case 'message':
          ...
          // if (!runs[sig.left]) runs[sig.left] = starts[sig.left] = getID('exe');
          // if (sig.right && !runs[sig.right]) runs[sig.right] = starts[sig.right] = getID('exe');
          ...
          // if (sig.line == 'reply') {
          //   if (sig.dir == 'left') runs[sig.right] = false;
          //   else if (sig.dir == 'right') runs[sig.left] = false;
          // }
          break;
        case 'note':
