(function() {
  ...
  $(window).on('beforeunload', function() {
    ...
    $('.virtual-border').each(function() {
      ...
      if (cap) $this.height($('.'+cap[1]).getRect().height);
    });
  });
  ...
  $menu.html(menu
    ...
    .add('Open URL...', function() {
      var url = prompt('Input URL for open', 'https://raw.githubusercontent.com/HikaruYasuda/markdown-uml-js/master/sample/sequence.md');
      if (url) loadURL(url);
    })
